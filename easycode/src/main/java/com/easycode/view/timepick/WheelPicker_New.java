 ...
 * @version 1.1.0
 */
public class WheelPicker_New extends View implements IDebug, IWheelPicker, Runnable {
    /**
     * 滚动状态标识值
     *
    ...
    private static final String TAG = WheelPicker_New.class.getSimpleName();
    ...
    public WheelPicker_New(Context context) {
        this(context, null);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 滚动内容
                // Scroll WheelPicker_New's content
            ...
            case MotionEvent.ACTION_UP:
                ...
                // 根据速度判断是该滚动还是滑动
                // Judges the WheelPicker_New is scroll or fling base on current velocity
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(WheelPicker_New picker, Object data, int position);
    }
    ...
    public interface OnWheelChangeListener {
         ...
         * <p>
         * Invoke when WheelPicker_New scroll stopped
         * WheelPicker_New will return a distance offset which between current scroll position and
         * initial position, this offset is a positive or a negative, positive means WheelPicker_New is
         * scrolling from bottom to top, negative means WheelPicker_New is scrolling from top to bottom
         *
         ...
         * <p>
         * Invoke when WheelPicker_New scroll stopped
         * This method will be called when WheelPicker_New stop and return current selected item data's
         * position in list
         *
         ...
         * <p>
         * Invoke when WheelPicker_New's scroll state changed
         * The state of WheelPicker_New always between idle, dragging, and scrolling, this method will
         * be called when they switch
         *
         * @param state 滚轮选择器滚动状态，其值仅可能为下列之一
         *              {@link WheelPicker_New#SCROLL_STATE_IDLE}
         *              表示滚动选择器处于静止状态
         *              {@link WheelPicker_New#SCROLL_STATE_DRAGGING}
         *              表示滚动选择器处于拖动状态
         *              {@link WheelPicker_New#SCROLL_STATE_SCROLLING}
         *              表示滚动选择器处于滑动状态
         *              <p>
         *              State of WheelPicker_New, only one of the following
         *              {@link WheelPicker_New#SCROLL_STATE_IDLE}
         *              Express WheelPicker_New in state of idle
         *              {@link WheelPicker_New#SCROLL_STATE_DRAGGING}
         *              Express WheelPicker_New in state of dragging
         *              {@link WheelPicker_New#SCROLL_STATE_SCROLLING}
