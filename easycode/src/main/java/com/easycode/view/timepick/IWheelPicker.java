...
/**
    ...
    public interface IWheelPicker {
         ...
         * 设置滚轮Item选中监听器
         *
         * @param listener 滚轮Item选中监听器{@link WheelPicker_New.OnItemSelectedListener}
         */
        void setOnItemSelectedListener(WheelPicker_New.OnItemSelectedListener listener);
        ...
        /**
         * 设置数据列表
         * 数据源可以是任意类型，但是需要注意的是WheelPicker_New在绘制数据的时候会将数据转换成String类型
         ...
         */
        void setOnWheelChangeListener(WheelPicker_New.OnWheelChangeListener listener);
        ...
        /**
         * 设置滚轮选择器数据项的对齐方式
         * 默认对齐方式为居中对齐{@link WheelPicker_New#ALIGN_CENTER}
         * <p>
         * Set alignment of WheelPicker
         * The default alignment of WheelPicker is {@link WheelPicker_New#ALIGN_CENTER}
         *
         * @param align 对齐方式标识值
         *              该值仅能是下列值之一：
         *              {@link WheelPicker_New#ALIGN_CENTER}
         *              {@link WheelPicker_New#ALIGN_LEFT}
         *              {@link WheelPicker_New#ALIGN_RIGHT}
         */
